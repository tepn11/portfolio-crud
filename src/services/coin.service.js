...
var findAll = function () {
  return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [4 /* yield*/, coin_1.CoinModel.find({}).exec()];
        case 1:
          response = _a.sent();
...
var update = function (id, newCoinData) {
  return __awaiter(void 0, void 0, void 0, function () {
    var idValid, response;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          return [
            4 /* yield*/,
            coin_1.CoinModel.findByIdAndUpdate(id, newCoinData),
          ];
        case 1:
          response = _a.sent();
          console.log(response);
